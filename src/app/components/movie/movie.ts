...
export class MovieComponent {
  ...
  to_not_see(): void {
    if (this.movie.Film_ANePasVoir == true) {
      ...
      this.http.get<string>(URL_API + "/update_delete_movie_not?id=" + this.movie.Film_IdAllocine).subscribe();
    } else {
      this.movie.Film_ANePasVoir = true;
      this.http.get<string>(URL_API + "/update_delete_movie?id=" + this.movie.Film_IdAllocine).subscribe();
    }
  }
  ...
  deja_vu(): void {
    if (this.movie.Film_Vue == true) {
      ...
      this.http.get<string>(URL_API + "/update_seen_movie_not?id=" + this.movie.Film_IdAllocine).subscribe();
    } else {
      this.movie.Film_Vue = true;
      this.http.get<string>(URL_API + "/update_seen_movie?id=" + this.movie.Film_IdAllocine).subscribe();
    }
  }
